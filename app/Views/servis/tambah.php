...
<main>
    ...
    <div class="container-fluid" style="margin-top: 4em">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active font-weight-bold text-dark">Tambah Data Servis</li>
        </ol>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- Form Tambah Buku -->
                <form action="/servis/tambah" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            'is-invalid' : '' ?>" id="tanggal_selesai" name="tanggal_selesai">
                            <div id="validationServer03Feedback" class="invalid-feedback">
