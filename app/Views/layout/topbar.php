<nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link">Tentang</a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              <div class="dropdown-title">Tentang
          ...
          <!-- <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link">Kontak</a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block"><?= user()->username ?><?=userLogin('username')?></div></a>
