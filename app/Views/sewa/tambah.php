    ...
    <div class="container-fluid" style="margin-top: 4em">
        ...
        <div class="card mb-4">
            ...
            <form action="/sewa/tambah" method="POST" enctype="multipart/form-data">
                ...
                <!-- Form Tambah Buku -->
                <input type="hidden" id="tahun1" class="form-control"  >
                ...
                <div class="mb-3 row" style="margin-top: 20px;">
                    ...
                    <h1><span id="total" name="total1" ></span>
                </div><input id="total1" type="hidden"name="total" >
...
<?= $this->include('sewa/modal-motor') ?>
<?= $this->include('sewa/modal-pelanggan') ?>
<script>
...
//     });
     $(document).ready(function() {
        // jumlahHari()
        // show()
        // document.getElementById('total').innerHTML="hgvshhvs";
     
    });
    function jumlahHari() {
        var tglBerangkat = document.getElementById('tglM').value;
        var tglKembali = document.getElementById('tglK').value;
        const d1 = new Date(tglBerangkat);
        const d2 = new Date(tglKembali);
        const time = Math.abs(d2 - d1);
        const days = Math.ceil(time / (1000 * 60 * 60 * 24));
        console.log(days);
        document.getElementById('lama').value = days;

        var price = document.getElementById('price').value;
        console.log(price);
        const total = Math.abs(price * days);
